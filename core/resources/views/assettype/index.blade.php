...
<section class="">
    <div class="content p-4">
        <div class="row pt-3">
            <div class="col-md-6">
                <h3 class=""><?php echo trans('lang.assettype_list');?></h3>
            </div>
...
"use strict";  
    $('#data').DataTable({
        ...
        buttons: [{
                ...
                title: '<?php echo trans('lang.assettype_list ');?>',
                exportOptions: {
                    columns: [1, 2]
                }
            },
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/assettype') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
