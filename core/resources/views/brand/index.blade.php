                        ...
                        <div class="table-responsive">
                            <table id="data" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th><?php echo trans('lang.brandname');?></th>
                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo trans('lang.brandname');?></label>
                            <input name="name" type="text" id="name" class=" form-control" required placeholder="<?php echo trans('lang.brandname');?>"/>
                        </div>
                        ...
                        <div class="form-group">
                                <label>Type</label>
                                <select name="brandtype" id="brandtype" required class="form-control">
            ...
            <div class="modal-content">
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo trans('lang.brandname');?></label>
                            <input name="name" type="text" id="editname" class=" form-control" required placeholder="<?php echo trans('lang.brandname');?>"/>
                        </div>
                        ...
                        <div class="form-group">
                                <label>Type</label>
                                <select name="vehiclecategory" id="editbrandtype" required class="form-control">
                                    <option value="" selected disabled>Type</option>
                                    <option value="tools">Tools</option>
                                    <option value="vehicle">Vehicle</option>
                                </select>
    ...
    $('#data').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/brand') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		...
		success: function(data) {
			...
			$("#editbrandtype").val(data.message.type);
