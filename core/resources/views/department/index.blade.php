            ...
            <div class="modal-content">
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo trans('lang.department');?></label>
                            <input name="name" type="text" id="editname" class=" form-control" required placeholder="<?php echo trans('lang.department');?>"/>
                        </div>
    ...
    $('#data').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/department') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
