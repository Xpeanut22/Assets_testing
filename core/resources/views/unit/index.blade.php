                ...
                <form action="#" id="formadd" enctype="multipart/form-data">
                    ...
                    <div  class="display-none messageexist alert alert-success"><?php echo trans('lang.data_exist');?></div>
                        <div class="form-group">
                            <label>Unit</label>
                            <input name="unit" type="text" id="unit" class=" form-control" required placeholder="Unit"/>
                        </div>
                        <div class="form-group">
                            <label>Description</label>
                            <input name="description" type="text" id="description" class=" form-control" required placeholder="Description"/>
                        </div>
    ...
    $('#data').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/unit') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
