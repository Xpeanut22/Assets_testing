...
class Typeofid extends Controller
{
    ...
    public function getdata(){
        $data = DB::table('typeofid')->select(['typeofid.*']);
    ...
    public function byid( Request $request ) {
        ...
        $data = DB::table('typeofid')->where('id', $id)->first();
    ...
    public function save(Request $request){
		...
		$insert         = DB::table( 'typeofid' )->insert( $data );
    ...
    public function update(Request $request){
		...
		$update = DB::table( 'typeofid' )->where( 'id', $id )
		->update(
			[
			'name'          => $name,
	...
	public function delete( Request $request ) {
		$id = $request->input( 'id' );
		$delete = DB::table( 'typeofid' )->where( 'id', $id )->delete();
            if ( $delete ) {
                $res['success'] = 'success';
            } else{
                $res['success'] = 'failed';
