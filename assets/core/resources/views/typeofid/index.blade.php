                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" id="name" class=" form-control" required placeholder="<?php echo trans('lang.department');?>"/>
                        </div>
            ...
            <div class="modal-content">
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label>I.D Name</label>
                            <input name="name" type="text" id="editname" class=" form-control" required placeholder="I.D Name"/>
                        </div>
    ...
    $('#data').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/typeofid') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
