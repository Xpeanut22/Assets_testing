...
<section class="">
    <div class="content p-4">
        <div class="row pt-3">
            <div class="col-md-6">
                <h3 class=""><?php echo trans('lang.clientslist');?></h3>
            </div>
            ...
            <div class="modal-content">
                <form action="#" id="formadd" enctype="multipart/form-data">
                    ...
                    <div  class="display-none messageexist alert alert-success"><?php echo trans('lang.data_exist');?></div>
                        ...
                        <div class="form-group">
                            <label><?php echo trans('lang.mobileno');?></label>
                            <input name="number" type="number" id="number" class=" form-control" required placeholder="<?php echo trans('lang.mobileno');?>"/>
                        </div>
                        <div class="form-group">
            ...
            <div class="modal-content">
                <form action="#" id="formedit" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label><?php echo trans('lang.mobileno');?></label>
                            <input name="number" type="number" id="editnumber" class=" form-control" required placeholder="<?php echo trans('lang.mobileno');?>"/>
                        </div>
                        <div class="form-group">
                            <label><?php echo trans('lang.email');?></label>
    ...
    $('#data').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/employee') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
...
$('#edit').on('show.bs.modal', function(e) {
	...
	$.ajax({
		...
		success: function(data) {
            ...
            $("#editnumber").val(data.message.mobile_number);
