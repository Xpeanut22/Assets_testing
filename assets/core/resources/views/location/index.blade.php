...
<section class="">
    <div class="content p-4">
        <div class="row pt-3">
            <div class="col-md-6">
                <h3 class=""><?php echo trans('lang.location_list');?></h3>
            </div>
                ...
                <form action="#" id="formadd">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input name="name" type="text" id="name" class=" form-control" required placeholder="<?php echo trans('lang.location');?>"/>
                        </div>
            ...
            <div class="modal-content">
                <form action="#" id="formedit">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <label><?php echo trans('lang.location');?></label>
                            <input name="name" type="text" id="editname" class=" form-control" required placeholder="<?php echo trans('lang.location');?>"/>
                        </div>
    ...
    <div class="modal fade" id="delete" role="dialog">
        ...
        <div class="modal-content">
            <form action="#" id="formdelete">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn btn-primary" id="confirmdelete"><?php echo trans('lang.delete');?></button>
    ...
    $('#data').DataTable({
        ...
        buttons: [{
            ...
            },
            {
                ...
                className: 'btn btn-sm btn-fill btn-info ',
                action: function() {
                    window.open("{{ url('/utilities/print/location') }}", '_blank');
                }
            },
            {
                className: 'btn btn-sm btn-fill btn-info ',
