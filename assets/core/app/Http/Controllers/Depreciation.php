...
class Depreciation extends Controller
{
    ...
    public function byid( Request $request ) {
        ...
        $data = DB::table('depreciation')
                ...
                ->leftjoin('assets', 'depreciation.assetid', '=', 'assets.id')
                ->leftjoin('component', 'depreciation.componentid', '=', 'component.id')
                ->where('depreciation.id', $id)
                ->where('depreciation.is_delete', 0)->first();
    ...
    public function save(Request $request){ 
        ...
        $data           = array('assetid'=>$assetid, 'componentid'=>$componentid,'period'=>$period,'assetvalue'=>$assetvalue,'is_delete'=>0,'created_at'=>$created_at, 'updated_at'=>$updated_at);
    ...
    public function update(Request $request){
		...
		$update = DB::table( 'depreciation' )->where( 'id', $id )->where('is_delete', 0)
		->update(
			[
            'period'        => $period,
	...
	public function delete( Request $request ) {
		$id = $request->input( 'id' );
		$delete = DB::table( 'depreciation' )->where( 'id', $id )->where('is_delete', 0)
    ...
    public function calculatorcomponent(Request $request){
        ...
        $data = DB::table('depreciation')
                ...
                ->leftjoin('component', 'depreciation.componentid', '=', 'component.id')
                ->where('depreciation.componentid', $id)
                ->where('depreciation.is_delete', 0)->first();
