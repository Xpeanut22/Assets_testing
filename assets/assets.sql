...
CREATE TABLE `asset_history` (
  ...
  `typeofid` int(11) DEFAULT NULL,
  `depid` int(11) DEFAULT NULL,
  `condition` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `used` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_by` bigint(20) UNSIGNED DEFAULT NULL,
  `control_number` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `component_assets` (
  ...
  `typeofid` int(11) DEFAULT NULL,
  `idno` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `department` bigint(20) UNSIGNED DEFAULT NULL,
  `date` date NOT NULL,
  `control_number` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `issuancetype` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `remarks` text COLLATE=utf8mb4_unicode_ci,
  `created_by` bigint(20) UNSIGNED DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
